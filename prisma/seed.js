...
async function generateCities() {
  const prague = await prisma.city.upsert({
    where: { name: 'Prague' },
    update: {
      name: 'Prague',
      turns: 9,
  ...
  const losAlamos = await prisma.city.upsert({
  ...
  const rioDeJaneiro = await prisma.city.upsert({
  ...
  const vaticanCity = await prisma.city.upsert({
  ...
  const monteCarlo = await prisma.city.upsert({
  ...
  const cairo = await prisma.city.upsert({
    where: { name: 'Cairo' },
    update: {
      name: 'Cairo',
      turns: 9,
  ...
  const baghdad = await prisma.city.upsert({
    where: { name: 'Baghdad' },
    update: {
      name: 'Baghdad',
      turns: 7,
  ...
  const yakutsk = await prisma.city.upsert({
    where: { name: 'Yakutsk' },
    update: {
      name: 'Yakutsk',
      turns: 8,
  ...
  const hongKong = await prisma.city.upsert({
  ...
  const pragueChoices = await prisma.city.update({
    where: { name: 'Prague' },
    data: {
      choices: {
  ...
  const berlinChoices = await prisma.city.update({
    where: { name: 'Berlin' },
    data: {
      choices: {
  ...
  const londonChoices = await prisma.city.update({
    where: { name: 'London' },
    data: {
      choices: {
  ...
  const montrealChoices = await prisma.city.update({
    where: { name: 'Montreal' },
    data: {
      choices: {
  ...
  const losAlamosChoices = await prisma.city.update({
    where: { name: 'Los Alamos' },
    data: {
      choices: {
  ...
  const parisChoices = await prisma.city.update({
    where: { name: 'Paris' },
    data: {
      choices: {
  ...
  const madridChoices = await prisma.city.update({
    where: { name: 'Madrid' },
    data: {
      choices: {
  ...
  const monteCarloChoices = await prisma.city.update({
    where: { name: 'Monte Carlo' },
    data: {
      choices: {
  ...
  const cairoChoices = await prisma.city.update({
    where: { name: 'Cairo' },
    data: {
      choices: {
        connect: [
  ...
  const casablancaChoices = await prisma.city.update({
    where: { name: 'Casablanca' },
    data: {
      choices: {
  ...
  const bogotaChoices = await prisma.city.update({
    where: { name: 'Bogota' },
    data: {
      choices: {
  ...
  const capeTownChoices = await prisma.city.update({
    where: { name: 'Cape Town' },
    data: {
      choices: {
  ...
  const sydneyChoices = await prisma.city.update({
    where: { name: 'Sydney' },
    data: {
      choices: {
        connect: [{ id: tokyo.id }],
  ...
  const baghdadChoices = await prisma.city.update({
    where: { name: 'Baghdad' },
    data: {
      choices: {
        connect: [{ id: dubai.id }],
  ...
  const dubaiChoices = await prisma.city.update({
    where: { name: 'Dubai' },
    data: {
      choices: {
  ...
  const moscowChoices = await prisma.city.update({
    where: { name: 'Moscow' },
    data: {
      choices: {
  ...
  const yakutskChoices = await prisma.city.update({
    where: { name: 'Yakutsk' },
    data: {
      choices: {
  ...
  const shanghaiChoices = await prisma.city.update({
    where: { name: 'Shanghai' },
    data: {
      choices: {
  ...
  const bangkokChoices = await prisma.city.update({
    where: { name: 'Bangkok' },
    data: {
      choices: {
